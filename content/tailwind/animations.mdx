...
<LessonCodeExample
  ...
  solution={`<div class="group relative overflow-hidden rounded-xl border-2 border-transparent bg-white p-6 shadow-sm transition-all duration-300 hover:shadow-lg">
