...
<Alert>
  <AlertTitle>
    <Lightbulb className="inline h-4 w-4" /> Tip
  </AlertTitle>
  <AlertDescription>
    Use subtle grays (gray-800, gray-900) for dark surfaces, not pure black.
    Pure black creates harsh contrast against other dark elements.
  </AlertDescription>
</Alert>
...
<Alert>
  ...
  <AlertDescription>
    Avoid flash of wrong theme. next-themes with enableSystem injects a script
    before React hydrates to prevent FOIT.
  </AlertDescription>
</Alert>
...
<InteractiveExercise
  ...
  hints={[
    "Every color needs a dark: counterpart",
    "Use dark:border-gray-700 and dark:bg-gray-800 for cards",
    "Button itself needs dark mode styles too",
  ]}
/>
