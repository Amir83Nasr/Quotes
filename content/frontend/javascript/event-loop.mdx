...
console.log(9)
// Expected output: 1, 9, 4, 7, 8, 2, 6, 3, 5`}
  language="javascript"
  explanation="Step by step: sync code 1,9 first. Then microtask queue drains: 4, nested queueMicrotask 7, which queues 8 — 8 runs before next macrotask. Macrotasks: first setTimeout logs 2, its microtask logs 3; remaining setTimeout logs 6; last setTimeout logs 5."
/>
