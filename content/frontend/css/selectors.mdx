...
<ul class="task-list">
  ...
  hints={[
    "Use nth-child(odd) for alternating rows",
    "Use nth-child(-n+2) for first 2 items",
    "Use ::before with content for custom bullets",
    "Use :has() if you can add markup inside the li",
  ]}
  previewType="html"
/>
