...
<Alert>
  <AlertTitle>Test Your Structured Data</AlertTitle>
  <AlertDescription>
    Use Google's Rich Results Test or Schema.org validator. Invalid JSON-LD is
    silently ignored — no error is shown to users.
  </AlertDescription>
</Alert>
