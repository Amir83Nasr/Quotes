...
<LearningObjectives
  objectives={[
    ...
    "Read context with use() as a more flexible alternative to useContext",
    "Create a promise-returning fetch function that suspends with use() and a Suspense boundary",
  ]}
/>
