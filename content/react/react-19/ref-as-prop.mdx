...
<LearningObjectives
  objectives={[
    ...
    "Pass a ref callback to a child component without wrapping it in forwardRef",
    "Use the ref cleanup return pattern to unsubscribe from an external event source",
  ]}
/>
...
<Alert>
  ...
  <AlertDescription>
    ...
    it a second time with <code>null</code>. Mixing the two styles in one
