...
explanation="useMemo filters 1000 items by search query on every keystroke. useCallback stabilizes the onChange handler so React.memo on ResultList can skip re-renders when query hasn't changed."
/>
