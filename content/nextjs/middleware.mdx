...
export const config = {
  ...
  explanation="Reads the session cookie. If user has no session and tries /dashboard, redirects to /login with original path as redirect query param. Matcher scopes middleware to dashboard routes only."
/>
