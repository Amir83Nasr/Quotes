...
<LearningObjectives
  objectives={[
    ...
    "Distinguish stateless HTTP from session state maintained by cookies or tokens",
    "Trace how a single URL fans out into many sub-requests for CSS, JS, images, and fonts",
  ]}
/>
